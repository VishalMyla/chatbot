...
![](https://files.readme.io/5a840bb-screen-capture_4.gif)
...
- Recreated the authentication flow.The auth flow will be performed just before sending the event.Changed APIs to async-await Swift.
